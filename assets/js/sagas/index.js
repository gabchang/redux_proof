...
import * as actions from 'actions/saga.act.js'
import { getUser, getRepo, getStarredByUser, getStargazersByRepo } from '../reducers/saga_selectors'
...
// id: login | fullName
// url: next page url. If not provided will use passed id to apiFn
...
export const fetchUser = R.partial(fetchEntity, [user, api.fetchUser])
export const fetchRepo = R.partial(fetchEntity, [repo, api.fetchRepo])
export const fetchStarred = R.partial(fetchEntity, [starred, api.fetchStarred])
export const fetchStargazers = R.partial(fetchEntity, [stargazers, api.fetchStargazers])
...
// Fetches data for a ser: user data + starred repos
